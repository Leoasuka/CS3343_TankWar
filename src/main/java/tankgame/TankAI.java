...
public class TankAI {
     ...
     */
    void moveTowardsPosition(int targetX, int targetY) {
     ...
     */
    Point findCoverPosition(Wall wall) {
     ...
     */
    void decideToShoot(double distance) {
     ...
     */
    boolean hasLineOfSight(Tank target) {
